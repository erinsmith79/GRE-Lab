...
```
 Next I need to add this consensus data to my merged data from chunk 1 liftOver() but how do I first get all the individual data tables for each chromosome onto one data table?
